(function(){
  ...
  var Maps = function(elt){
    ...
    // Derived from Wikipedia’s List of countries and territories by land borders
    // Derived from Land borders by state
    // Derived from Garrett Robinson’s The Strategy of Risk
    var _sources = {
      nations:'<a target="_blank" href="http://en.wikipedia.org/wiki/List_of_countries_and_territories_by_land_borders"></a>',
      states:'<a target="_blank" href="http://www.statemaster.com/graph/geo_lan_bou_bor_cou-geography-land-borders"></a>',
      risk:'<a target="_blank" href="http://web.mit.edu/sp.268/www/risk.pdf"></a>'
    }

    var _maps = {
      plang:{title:"Programming Languages", p:{stiffness:600}, source:_sources.states},
      framework:{title:"Frameworks & Libraries", p:{stiffness:300}, source:_sources.nations},
      database:{title:"Databases & Tools", p:{stiffness:500}, source:_sources.nations},
